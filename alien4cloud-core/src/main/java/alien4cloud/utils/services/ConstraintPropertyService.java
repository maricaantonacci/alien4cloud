...
public class ConstraintPropertyService {
    ...
    public void checkPropertyConstraint(String propertyName, Object propertyValue, PropertyDefinition propertyDefinition, ArchiveRoot archive)
        ...
        if (propertyValue instanceof String) {
            ...
            checkSimplePropertyConstraint(propertyName, ((ScalarPropertyValue) propertyValue).getValue(), propertyDefinition);
        } else if (propertyValue instanceof ListPropertyValue) {
            checkListPropertyConstraint(propertyName, ((ListPropertyValue) propertyValue).getValue(), propertyDefinition, archive);
        } else if (propertyValue instanceof ComplexPropertyValue) {
            checkComplexPropertyConstraint(propertyName, ((ComplexPropertyValue) propertyValue).getValue(), propertyDefinition, archive);
