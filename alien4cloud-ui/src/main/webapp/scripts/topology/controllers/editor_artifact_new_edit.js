define(function (require) {
  ...
  modules.get('a4c-topology-editor', ['ui.bootstrap']).controller('TopologyEditorArtifactNewEditCtrl',
    ['$scope', '$uibModalInstance', '$translate', 'explorerService','archiveContentTree', 'availableRepositories', 'artifact', 'topology', 'isCreateNew', 'toaster',
    function($scope, $uibModalInstance, $translate, explorerService, archiveContentTree, availableRepositories, artifact, topology, isCreateNew, toaster) {
